...
public class Look4 : MonoBehaviour
{
    ...
    void SetY()
    {
        ...
        {
            inputY = controller.state4.ThumbSticks.Right.Y * adjustY * Time.deltaTime;
        }
        else
        {
     ...
     void SetX()
    {
        ...
        if(controller.state4.IsConnected)
        {
            inputX = controller.state4.ThumbSticks.Right.X * adjustX * Time.deltaTime;
        }
        else
        {
